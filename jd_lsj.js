...
!(async () => {
  ...
  console.log(`\n开始帮【pkpkgtr】助力，感谢！\n`);
  let shareCodes = [
    '256374288776B0B5452D8217036DE8C53BE91E1D686558611994A2AD014DF9A4DA08C32A85A4998DA623D55F09304D21F81AC71C44E1E91F3186C64566090D6EDDDA672BF446E2FCC0D1D6B4E52826D1',
    'F5932CA6F169EA814EBB2A2C8E6B64C56E502FF8E526449B831830244067A76974D05EDAD17077AFFA80DAD7387DD28B3BEE5701143FCA11A003164F79A3ADAEDDDA672BF446E2FCC0D1D6B4E52826D1',
    'D2FCDA742AF10E50ECE2252EEE7E5976905959799EAD3EA03596036BFBD98F8349336DE54E26AA8F2834B248E6398CB7A755DF4FDAE585EC3E1ABE26F3DD3CFFC956D12974FF00A045D8E31A84FE84C18A8357'
  ];
  for (let i = 0; i < cookiesArr.length; i++) {
    cookie = cookiesArr[i];
    $.UserName = decodeURIComponent(cookie.match(/pt_pin=([^; ]+)(?=;?)/) && cookie.match(/pt_pin=([^; ]+)(?=;?)/)[1])
    ...
    for (let j = 0; j < shareCodes.length && $.canHelp; j++) {
      ...
      console.log(`${$.UserName}去助力【pkpkgtr】`)
      nick = useInfo[$.UserName];
