...
$.appid = 'o2_act';
const UA = $.isNode() ? (process.env.JD_USER_AGENT ? process.env.JD_USER_AGENT : `jdapp;iPhone;10.0.6;${Math.ceil(Math.random()*2+12)}.${Math.ceil(Math.random()*4)};${randomString(40)};`) : ($.getdata('JDUA') ? $.getdata('JDUA') : `jdapp;iPhone;10.0.6;${Math.ceil(Math.random()*2+12)}.${Math.ceil(Math.random()*4)};${randomString(40)};`)
...
async function takePostRequest(type) {
  ...
  switch (type) {
    case 'olympicgames_home':
      body = `functionId=olympicgames_home&body={"ss":"{\"extraData\":{\"log\":\"1626404344349~1GoXKutyDLkMDFTQlNYVjAxMQ==.YnRhbmJjcWJrYWt7ZyY9BC0LaScFcz49KGJuZXRjf3AtaihiPC0=.5c20aaaa~5,2~AA79F90C1039EC8F82425DB764620895BCFF2E591BC1F634623615FBF21DB244~19m7790~C~~0fm3o35\",\"sceneid\":\"OY217hPageh5\"},\"random\":\"17563354\"}"}&client=wh5&clientVersion=1.0.0&appid=${$.appid}`;
